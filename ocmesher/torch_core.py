...
class TorchOcMesher:
    ...
    def close(self):
        """Clean up resources (for test compatibility).

        TorchOcMesher doesn't have persistent resources to clean up,
        but we provide this method for test compatibility with the fixture.
        """
